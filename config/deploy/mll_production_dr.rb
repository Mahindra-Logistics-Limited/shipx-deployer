...
#set :rvm_custom_path, '/home/shipx/.rvm/bin/rvm'
set :delayed_threads, 10

set :bundle_path, lambda { File.join(deploy_to, "bundle") }

set :rails_env, "production"
role :web, %w{shipx@10.175.20.72}
role :app, %w{shipx@10.175.20.72}
role :db,  %w{shipx@10.175.20.72}, primary: true
